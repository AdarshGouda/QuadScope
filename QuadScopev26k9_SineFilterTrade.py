...
class SlimIfLutPane(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self.table = QTableWidget(25, 9)
        self.table.setHorizontalHeaderLabels([
            "Speed [rpm]", "Iq Ref [pu]", "Iq eff [Arms]", "Output torque [ft-lbf]",
            "Req motor torque [lb-in]", "Useful capability [lb-in]", "Util [%]", "Iq max [Arms]", "Notes"
        ])
...
class NavigatorVfWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("QuadScope v26k.9 - Sine Filter Trade")
    ...
    def _plot_sweep_sine_filter_trade(self):
        ...
        for cf_uf in cfs_uf:
            ...
            _, _, i_shunt = model.sine_filter_shunt_current_components(motor_rpm, v_node)
            ...
            v_filter_drop = max(0.0, float(v_inv_req) - float(v_node))
